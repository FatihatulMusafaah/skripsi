...
<style>
    .mdtp__wrapper { font-family: inherit; }
    .mdtp__button { color: #2563eb !important; }
    .mdtp__digit.active, .mdtp__clock-dot, .mdtp__am.active, .mdtp__pm.active { background-color: #2563eb !important; }
    .mdtp__hand, .mdtp__hand-dot { fill: #2563eb !important; stroke: #2563eb !important; }
</style>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="jam_masuk" id="jam_masuk" value="{{ substr($absensi->jam_masuk, 0, 5) }}" readonly
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="jam_keluar" id="jam_keluar" value="{{ $absensi->jam_keluar ? substr($absensi->jam_keluar, 0, 5) : '' }}" readonly
