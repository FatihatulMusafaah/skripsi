...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    <a href="{{ route('owner.laporan') }}" class="bg-white p-6 rounded-xl shadow hover:shadow-lg transition border-l-4 border-blue-500">
    ...
    <a href="{{ route('owner.laporan') }}" class="bg-white p-6 rounded-xl shadow hover:shadow-lg transition border-l-4 border-green-500">
        <h3 class="text-gray-500 text-sm font-semibold uppercase">Laporan Absensi</h3>
        <p class="text-xs text-gray-400 mt-1">Klik untuk melihat detail</p>
    </a>
    <a href="{{ route('owner.laporan') }}" class="bg-white p-6 rounded-xl shadow hover:shadow-lg transition border-l-4 border-yellow-500">
        <h3 class="text-gray-500 text-sm font-semibold uppercase">Laporan Penggajian</h3>
        <p class="text-xs text-gray-400 mt-1">Klik untuk melihat detail</p>
    </a>
    <a href="{{ route('owner.laporan') }}" class="bg-white p-6 rounded-xl shadow hover:shadow-lg transition border-l-4 border-red-500">
